...
- Running a Python script that calls the Agentik Team API
...
1. Agentik Team spawns the configured command as a child process
2. Standard Agentik Team environment variables are injected (`AGENTIK_AGENT_ID`, `AGENTIK_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Agentik Team API and perform work.
