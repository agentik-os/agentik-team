...
summary: What adapters are and how they connect agents to Agentik Team
---

Adapters are the bridge between Agentik Team's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, Agentik Team:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `agentik-team run --watch`
```
