...
Manage companies within your Agentik Team instance.
...
Company logo uploads use the normal Agentik Team attachment size limit.
...
| `logoUrl` | string | Optional Agentik Team asset content path for the stored logo image |
