...
- `AGENTIK_APPROVAL_ID` — the resolved approval
- `AGENTIK_APPROVAL_STATUS` — `approved` or `rejected`
- `AGENTIK_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
