...
export function MarkdownBody({ children, className, resolveImageSrc }: MarkdownBodyProps) {
        ...
        return (
          <a
            ...
            className={cn(
              ...
              `agentik-mention-chip--${parsed.kind}`,
              parsed.kind === "project" && "agentik-project-mention-chip",
            )}
  ...
  return (
    <div
      className={cn(
        "agentik-markdown prose prose-sm max-w-none break-words overflow-hidden",
