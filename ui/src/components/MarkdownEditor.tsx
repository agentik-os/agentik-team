...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("agentik-project-mention-chip");
      ...
      link.classList.add("agentik-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative agentik-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("agentik-mdxeditor", !bordered && "agentik-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "agentik-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
