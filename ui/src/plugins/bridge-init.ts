 ...
 *
 * This is placed on `globalThis.__agentikPluginBridge__` and consumed by
...
declare global {
  ...
  var __agentikPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__agentikPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__agentikPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
