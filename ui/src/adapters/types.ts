...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@agentik-os/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@agentik-os/adapter-utils").TranscriptEntry[];
