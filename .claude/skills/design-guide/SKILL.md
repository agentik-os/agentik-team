...
name: design-guide
description: >
  Agentik Team UI design system guide for building consistent, reusable frontend
...
# Agentik Team Design Guide

Agentik Team's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Agentik Team-specific design language.
