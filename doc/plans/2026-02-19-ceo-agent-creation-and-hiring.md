...
- installed adapter list for this Agentik Team instance
...
## 8. New Skill: `agentik-create-agent`

Create new skill directory:

- `skills/agentik-create-agent/SKILL.md`
...
Also update `skills/agentik-team/SKILL.md` to reference this skill for hiring workflows.
...
- `agentik-create-agent` skill + docs updates
