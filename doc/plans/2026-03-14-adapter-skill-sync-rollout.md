...
This document defines the rollout plan for adapter-wide skill support in Agentik Team.
...
- Agentik Team stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

Agentik Team currently has these adapters:
...
1. Desired skills live in Agentik Team for every adapter.
...
These adapters have a stable local skills directory that Agentik Team can read and manage.
...
These adapters do not have a meaningful Agentik Team-owned persistent install state.
...
- show desired Agentik Team skills
...
- desired skills stored in Agentik Team
...
- runtime already injects Agentik Team skills into `~/.cursor/skills`
...
- runtime already injects Agentik Team skills into `~/.gemini/skills`
...
- runtime already injects Agentik Team skills into `~/.pi/agent/skills`
...
- Agentik Team can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects Agentik Team skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- Agentik Team may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed Agentik Team skills that are clearly marked as Agentik Team-managed
...
- Agentik Team stores desired skills only
...
- avoid destructive wording unless Agentik Team can prove a skill is Agentik Team-managed
...
That gets Agentik Team from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
