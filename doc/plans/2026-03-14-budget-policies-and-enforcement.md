...
Agentik Team already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Agentik Team should implement next.

## Product Goals

Agentik Team should let operators:
...
For the next implementation pass, Agentik Team should enforce these defaults:
...
Agentik Team should separate subscription-included usage from billed spend:
...
Agentik Team should have two threshold classes:
...
Agentik Team must know that a project is budget-paused and enforce it.
...
Agentik Team must also block execution before new work starts.
