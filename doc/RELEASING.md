...
2. **npm** — `agentik-team` and public workspace packages are published
...
[Run the action here](https://github.com/agentik-os/agentik-team/actions/workflows/release.yml)
...
- `npx agentik-team@canary onboard` installs
