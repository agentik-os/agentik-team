...
This document covers the GitHub and npm setup required for the current Agentik Team release model:
...
Do this for every public package that Agentik Team publishes.
...
3. add a trusted publisher for the GitHub repository `agentik-os/agentik-team`
...
2. revoke any personal automation token that used to publish Agentik Team
