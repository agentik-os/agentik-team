...
```bash
pnpm --filter @agentik-os/server test:run -- openclaw-gateway
pnpm --filter @agentik-os/server typecheck
pnpm --filter @agentik-os/ui typecheck
pnpm --filter agentik-team typecheck
```
