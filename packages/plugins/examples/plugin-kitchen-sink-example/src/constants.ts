import type { PluginLauncherRegistration } from "@agentik-os/plugin-sdk";

export const PLUGIN_ID = "agentik-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".agentik-kitchen-sink-demo.txt",
} as const;
