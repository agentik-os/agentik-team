# @agentik-os/plugin-kitchen-sink-example
...
```sh
pnpm --filter @agentik-os/plugin-kitchen-sink-example build
pnpm agentik-team plugin install ./packages/plugins/examples/plugin-kitchen-sink-example
```
