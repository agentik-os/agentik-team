/**
 * `@agentik-os/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@agentik-os/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@agentik-os/plugin-sdk/ui";
 *
