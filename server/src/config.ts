...
const isSameFile = existsSync(CWD_ENV_PATH) && existsSync(AGENTIK_ENV_FILE_PATH)
  ? realpathSync(CWD_ENV_PATH) === realpathSync(AGENTIK_ENV_FILE_PATH)
  : CWD_ENV_PATH === AGENTIK_ENV_FILE_PATH;
