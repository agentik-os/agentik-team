/**
 * PluginEventBus — typed in-process event bus for the Agentik Team plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@agentik-os/shared";
import type { PluginEvent, EventFilter } from "@agentik-os/plugin-sdk";
