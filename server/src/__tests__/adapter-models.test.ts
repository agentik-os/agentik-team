...
import { models as codexFallbackModels } from "@agentik-os/adapter-codex-local";
import { models as cursorFallbackModels } from "@agentik-os/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@agentik-os/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.AGENTIK_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.AGENTIK_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
