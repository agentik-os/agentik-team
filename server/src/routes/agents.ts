...
import { agents as agentsTable, companies, heartbeatRuns } from "@agentik-os/db";
...
import { runClaudeLogin } from "@agentik-os/adapter-claude-local/server";
import {
  DEFAULT_CODEX_LOCAL_BYPASS_APPROVALS_AND_SANDBOX,
  DEFAULT_CODEX_LOCAL_MODEL,
} from "@agentik-os/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@agentik-os/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@agentik-os/adapter-gemini-local";
import { ensureOpenCodeModelConfiguredAndAvailable } from "@agentik-os/adapter-opencode-local/server";
import {
...
export function agentRoutes(db: Db) {
  ...
  const strictSecretsMode = process.env.AGENTIK_SECRETS_STRICT_MODE === "true";
