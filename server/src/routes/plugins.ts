...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@agentik-os/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@agentik-os/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@agentik-os/plugin-sdk";
...
interface PluginInstallRequest {
  /** npm package name (e.g., @agentik-os/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@agentik-os/plugin-hello-world-example",
    pluginKey: "agentik.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the Agentik Team dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@agentik-os/plugin-file-browser-example",
    pluginKey: "agentik-file-browser-example",
  ...
  {
    packageName: "@agentik-os/plugin-kitchen-sink-example",
    pluginKey: "agentik-kitchen-sink-example",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "agentik.claude-usage",
