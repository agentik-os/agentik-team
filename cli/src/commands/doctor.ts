...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" agentik-team doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `agentik-team configure --section database` or `agentik-team onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadAgentikEnvFile(input.configPath);
