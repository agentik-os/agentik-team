...
name: release
description: >
  Coordinate a full Agentik Team release across engineering verification, npm,
...
Run the full Agentik Team maintainer release workflow, not just an npm publish.
...
7. If running through Agentik Team, you have issue context for status updates and follow-up task creation.
...
Agentik Team now uses a commit-driven release model:
...
npm view agentik-team@canary version
```
...
- release summary in Agentik Team issue context
