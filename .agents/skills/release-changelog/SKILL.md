...
description: >
  Generate the stable Agentik Team release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** Agentik Team release.

## Versioning Model

Agentik Team uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/agentik-os/agentik-team/pull/123), @contributor1, @contributor2)
```
